...
class LibraryManagementSys
{
    ...
    static int count = 0;
    static string role = "";
    static string password = "paobhaji@Ganga-mess"; // the passkey for admin
    ...
    public static void SelectRole()
    {
        ...
        if (choice == 1) //choice for role as admin or user
        {
            role = "Admin";
        }
        else
    ...
    public static bool Secure() //to verify the pass
    {
        if (role == "Admin")
        {
    ...
    public static void DisplayBooks()
    {
        ...
        { // display all columns for the arrays
